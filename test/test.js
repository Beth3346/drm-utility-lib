...
describe('elr', function() {
    ...
    describe('#compare', function() {
        it('should sort 2 numbers', function() {
            expect(elr.compare(2, 1)).to.equal(1)
            expect(elr.compare(1, 2)).to.equal(-1)
            expect(elr.compare(2, 2)).to.equal(0)
            expect(elr.compare(2.1, 2.2)).to.equal(2.1 - 2.2)
            expect(elr.compare(1, 2, 'descending')).to.equal(2 - 1)
        })
    })
    ...
    describe('#parseTime', function() {
        it('should return a 24hour formatted time', function() {
            expect(elr.parseTime('03:14pm')).to.equal('15:14')
            expect(elr.parseTime('03:14am')).to.equal('03:14')
            expect(elr.parseTime('3:14pm')).to.equal('15:14')
            expect(elr.parseTime('12:14pm')).to.equal('12:14')
            expect(elr.parseTime('12:14am')).to.equal('00:14')
            expect(elr.parseTime('3:14')).to.be.null
        })
    })
    describe('#sortTime', function() {
        it('should sort a list of times', function() {
